...
At the end of the build the image will be automatically saved in *@board-alias@/yocto/build/tmp/deploy/images* folder.

8. The next step is copy the image built in *@board-alias@/sysroot/* folder:

::

	$ sudo tar -zxvf tmp/deploy/images/@board-alias@/core-image-minimal-dev.tgz -C /home/architech/architech_sdk/architech/@board-alias@/sysroot/
